...
<body>
  ...
  <a class="navbar-brand title font-weight-bold" style="color: #C84B31;" href="logout.php">Log Out</a>
    ...
    <?php echo "<h3 class='text-center'>Selamat Datang, " . $_SESSION['name'] ."!". "</h3>"; ?>
		<h1 class="title text-center">Daftar Nasabah</h1>
    <div class="card">
				...
				<table id="example" class="table table-striped table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td>
									<a href="edit_person.php?personid=<?= $row['personid']; ?>" class="btn btn-sm btn-warning"><span data-feather="edit"></span></a>
									<a href="delete_person.php?personid=<?= $row['personid']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('anda yakin ingin hapus?');"><span data-feather="trash-2"></span></a>
									<a href="makepdf.php?personid=<?= $row['personid']; ?>" class="btn btn-sm btn-info"><span data-feather="file-text"></span></a>
							</td>
						</tr>
